...
namespace TradingBotV2.Utils
{
    ...
    //    Trades =
    //    {
    //        new Trade(TradingBotV2.Broker.Orders.OrderAction.BUY, 1074, "GME", 22.78, 5.37, DateTime.Parse("2023-05-18 09:50:57")),
    //        new Trade(TradingBotV2.Broker.Orders.OrderAction.SELL, 1074, "GME", 23.18, 5.37, DateTime.Parse("2023-05-18 10:48:02")),
    //        new Trade(TradingBotV2.Broker.Orders.OrderAction.BUY, 1074, "GME", 23.19, 5.37, DateTime.Parse("2023-05-18 11:09:54")),
    //        new Trade(TradingBotV2.Broker.Orders.OrderAction.SELL, 1074, "GME", 23.21, 5.37, DateTime.Parse("2023-05-18 11:44:57")),
    //        new Trade(TradingBotV2.Broker.Orders.OrderAction.BUY, 1081, "GME", 23.04, 5.405, DateTime.Parse("2023-05-18 11:58:57")),
    //        new Trade(TradingBotV2.Broker.Orders.OrderAction.SELL, 1081, "GME", 23.03, 5.405, DateTime.Parse("2023-05-18 13:06:08")),
    //        new Trade(TradingBotV2.Broker.Orders.OrderAction.BUY, 1083, "GME", 22.98, 5.415, DateTime.Parse("2023-05-18 14:00:12")),
    //        new Trade(TradingBotV2.Broker.Orders.OrderAction.SELL, 1083, "GME", 23.16, 5.415, DateTime.Parse("2023-05-18 15:19:10")),
    //        new Trade(TradingBotV2.Broker.Orders.OrderAction.BUY, 1086, "GME", 23.08, 5.43, DateTime.Parse("2023-05-18 15:37:56")),
    //        new Trade(TradingBotV2.Broker.Orders.OrderAction.SELL, 1086, "GME", 23.03, 5.43, DateTime.Parse("2023-05-18 15:59:59")),
    //    }
    //};
}
